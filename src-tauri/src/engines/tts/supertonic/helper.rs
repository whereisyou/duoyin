//! 移植自 Supertonic 官方 Rust 运行时（rust/src/helper.rs）
//! 上游：https://github.com/supertone-inc/supertonic （MIT License, (c) 2025 Supertone Inc.）
//! 接入时删除了本工程未用到的上游死函数（timer/sanitize_filename/batch/load_text_to_speech）。
